    ...
    <div id="page-wraper">
      ...
      <div class="responsive-nav">
        ...
        <div id="menu" class="menu">
          ...
          <div class="container">
            <div class="image">
              <a href="frontend/#"><img src="frontend/assets/images/aslan.jpg" alt="" /></a>
            </div>
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                <li><a href="frontend/#section1">About Me</a></li>
                <li><a href="frontend/#section2">What I’m good at</a></li>
                <li><a href="frontend/#section3">My Work</a></li>
                <li><a href="frontend/#section4">Contact Me</a></li>
              </ul>
            </nav>
            <div class="social-network">
              <ul class="soial-icons">
                <li>
                  <a href="frontend/https://fb.com/templatemo"
                ...
                <li>
                  <a href="frontend/#"><i class="fa fa-linkedin"></i></a>
                </li>
                <li>
                  <a href="frontend/#"><i class="fa fa-dribbble"></i></a>
                </li>
                <li>
                  <a href="frontend/#"><i class="fa fa-rss"></i></a>
                </li>
              </ul>
            </div>
      ...
      <section class="section about-me" data-section="section1">
        <div class="container">
          <div class="section-heading">
            <div class="row">
                <div class="col-md-12">
                    <img style="width:210px;height:260px;" src="frontend/assets/images/aslan.jpg" alt="" />
                </div>
            </div>
            <h2>Sulaslan Setiawan</h2>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="left-image">
                  <img src="frontend/assets/images/left-image.jpg" alt="" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="right-text">
                  ...
                  <p>
                    <ul>
                        <li>Description : Lorem ipsum dolor sir amet </li>
                        <br>
                        <li>Technologies used : laravel 10, reactjs, inertia </li>
                        <br>
                        <li>URL : aslanasilon.com </li>
                        <br>
                        <li>GitHub : </li>
                        <br>
                  ...
                  <div class="white-button">
                    <a href="frontend/#">Details screenshots</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="isotope-box">
                <div class="isotope-item" data-type="nature">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-01.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-01.jpg"
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-02.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-02.jpg"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-03.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-03.jpg"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="people">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-04.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-04.jpg"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="nature">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-05.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-05.jpg"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
                ...
                <div class="isotope-item" data-type="animals">
                  <figure class="snip1321">
                    <img
                      src="frontend/assets/images/portfolio-06.jpg"
                      alt="sq-sample26"
                    />
                    <figcaption>
                      <a
                        href="frontend/assets/images/portfolio-06.jpg"
                        data-lightbox="image-1"
                        data-title="Caption"
                        ><i class="fa fa-search"></i
                      ></a>
